...
#######################################################################################################################
        # Example options
        teams = ["All","Customer Support", "Deployment", "Sales", "Billing and Collections", "Technical Team", "Other"]
    ...
    with st.spinner("Processing data... Please wait."):
        ...
        for option in call_type_options:
            ...
            if dfs[option].empty:
                ...
                # Format Timeframe like monthly dataframe: "2024-07"
                display_df["Timeframe"] = (
                    pd.to_datetime(display_df["Timeframe"], errors="coerce")
                    .dt.to_period("M")
                )
                st.dataframe(display_df)
